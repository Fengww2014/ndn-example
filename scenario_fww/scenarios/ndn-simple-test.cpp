...
main(int argc, char* argv[])
{
  ...
  for (uint32_t i = 0; i < nodes.GetN (); ++i) {
       ...
       switch(i)
        {case 0:   initialAlloc->Add (Vector (150, 0, 0)); break;
	 case 1:   initialAlloc->Add (Vector (250, 0, 0)); break;
	 case 2:   initialAlloc->Add (Vector (350, 0, 0));break;
	 case 3:   initialAlloc->Add (Vector (450, 0, 0));break;
	// case 4:   initialAlloc->Add (Vector (600, 0, 0));break;
	// case 5:   initialAlloc->Add (Vector (750, 0, 0));break; 
        }
...
// Consumer
ndn::AppHelper consumerHelper("ns3::ndn::FWWConsumerCbr");
