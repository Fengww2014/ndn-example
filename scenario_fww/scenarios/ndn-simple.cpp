...
main(int argc, char* argv[])
{
  ...
  for (uint32_t i = 0; i < nodes.GetN (); ++i) {
	 ...
	 case 1:   initialAlloc->Add (Vector (50, 0, 0)); break;
	 case 2:   initialAlloc->Add (Vector (100, 0, 0));break;
	 case 3:   initialAlloc->Add (Vector (150,0, 0));break;
	 case 4:   initialAlloc->Add (Vector (200, 0, 0));break;
	 case 5:   initialAlloc->Add (Vector (250, 0, 0));break; 
        }
...
consumerHelper.SetAttribute("Frequency", StringValue("0.25")); // 10 interests a second
consumerHelper.SetAttribute("LifeTime", StringValue("2s")); // 10 interests a second
...
//ndn::FibHelper::AddRoute(nodes.Get(0), "/prefix", netdev://[00:00:00:00:00:02], 1);
