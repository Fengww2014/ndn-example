 ...
 NS_LOG_COMPONENT_DEFINE("fww-adhoc");
 int main(int argc, char* argv[])
 { 
  
   CommandLine cmd;
   cmd.Parse(argc, argv);
   LogComponentEnable("fww-adhoc", LOG_LEVEL_ALL);
   ...
   wifiPhyHelper.Set("TxPowerStart", DoubleValue(1));
...
//著作权归作者所有。商业转载请联系作者获得授权，非商业转载请注明出处。
  ...
  ssSpeed << "ns3::UniformRandomVariable[Min=15|Max=" << 24<< "]";
