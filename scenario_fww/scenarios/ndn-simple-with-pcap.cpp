...
main(int argc, char* argv[])
{
  ...
  Simulator::Schedule(Seconds(10.0), ndn::LinkControlHelper::FailLink, nodes.Get(2), nodes.Get(3));
  Simulator::Schedule(Seconds(15.0), ndn::LinkControlHelper::UpLink, nodes.Get(2), nodes.Get(3));
  Simulator::Run();
  Simulator::Destroy();
