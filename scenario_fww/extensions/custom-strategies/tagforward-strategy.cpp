#include "tagforward-strategy.hpp"
...
NFD_LOG_INIT("TagforwardStrategy");

namespace nfd {
namespace fw {

TagforwardStrategy::TagforwardStrategy(Forwarder& forwarder, const Name& name)
  : Strategy(forwarder)
{
  this->setInstanceName(makeInstanceName(name, getStrategyName()));
}

TagforwardStrategy::~TagforwardStrategy()
{
}
...
void
TagforwardStrategy::afterReceiveInterest(const Face& inFace, const Interest& interest,
...
const Name&
TagforwardStrategy::getStrategyName()
{
  static Name strategyName("ndn:/localhost/nfd/strategy/tagforward/%FD%01");
  return strategyName;
}
